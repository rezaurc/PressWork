...
##   $ docker build -t php-for-rezaurc-presswork .
##
## RUNNING
##   $ docker run -p 9000:9000 php-for-rezaurc-presswork
##
## CONNECTING
...
ENV STACKSMITH_STACK_ID="xxqfwoz" \
    STACKSMITH_STACK_NAME="PHP for rezaurc/PressWork" \
